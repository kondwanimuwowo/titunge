---
url: "https://lenco-api.readme.io/v2.0/reference/test-cards-and-accounts"
title: "Test Cards and Accounts"
---

[Jump to Content](https://lenco-api.readme.io/v2.0/reference/test-cards-and-accounts#content)
...
[Log In](https://lenco-api.readme.io/login?redirect_uri=/reference/test-cards-and-accounts) [![Lenco API](https://files.readme.io/cf066d0-small-512.jpg)](https://lenco.co/)

API Reference

[Log In](https://lenco-api.readme.io/login?redirect_uri=/v2.0/reference/test-cards-and-accounts)
...
### Mobile Money Test Accounts   [Skip link to Mobile Money Test Accounts](https://lenco-api.readme.io/v2.0/reference/test-cards-and-accounts\#mobile-money-test-accounts)
...
### Test Cards   [Skip link to Test Cards](https://lenco-api.readme.io/v2.0/reference/test-cards-and-accounts\#test-cards)
...
[Accept Payments](https://lenco-api.readme.io/v2.0/reference/accept-payments) [Accounts](https://lenco-api.readme.io/v2.0/reference/accounts)
