---
url: "https://lenco-api.readme.io/v2.0/reference/get-account-by-id"
title: "/accounts/:id"
---

[Jump to Content](https://lenco-api.readme.io/v2.0/reference/get-account-by-id#content)
...
[Log In](https://lenco-api.readme.io/login?redirect_uri=/reference/get-account-by-id) [![Lenco API](https://files.readme.io/cf066d0-small-512.jpg)](https://lenco.co/)

API Reference

[Log In](https://lenco-api.readme.io/login?redirect_uri=/v2.0/reference/get-account-by-id)
...
https://api.lenco.co/access/v2/accounts/{id}
...
[Skip link to Path Params](https://lenco-api.readme.io/v2.0/reference/get-account-by-id#path-params) Path Params
...
[Skip link to Responses](https://lenco-api.readme.io/v2.0/reference/get-account-by-id#response-schemas) Responses
...
[/accounts](https://lenco-api.readme.io/v2.0/reference/get-accounts) [/accounts/:id/balance](https://lenco-api.readme.io/v2.0/reference/get-account-balance)
...
[Log in to use your API keys](https://lenco-api.readme.io/login?redirect_uri=/v2.0/reference/get-account-by-id)
...
curl --request GET \
     ...
     --url https://api.lenco.co/access/v2/accounts/id \
