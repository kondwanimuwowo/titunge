...
export const MANUAL_SECTIONS: ManualSection[] = [
      ...
      <div className="space-y-6">
        <div className="prose max-w-none">
          <p className="text-muted-foreground leading-relaxed">
            Welcome to <strong>Titunge</strong>. This system is your digital assistant, designed to help you manage orders, track materials, and understand your business profits without needing to be a computer expert.
          </p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
          <div className="p-4 rounded-xl bg-card shadow-sm hover:shadow-md transition-all">
        ...
        <div className="bg-primary/10 p-6 rounded-xl flex gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Bookmark this page in your browser by clicking the star icon in the address bar so you can find it instantly every morning.
            </p>
          </div>
        </div>
      </div>
    ...
    content: (
      <div className="space-y-8">
          ...
          <div className="space-y-5">
            {[
              ...
              <div key={i} className="flex gap-4 group">
                <div className="h-10 w-10 rounded-full bg-muted flex items-center justify-center font-bold text-sm text-muted-foreground group-hover:bg-primary group-hover:text-primary-foreground transition-colors flex-shrink-0">
                  {i + 1}
                </div>
        ...
        <div className="p-6 bg-slate-900 rounded-xl text-white">
          <h4 className="font-bold flex items-center gap-2 mb-4 text-primary text-lg">
            <AlertCircle size={20} />
          ...
          <div className="flex flex-wrap gap-2">
            {["Pending", "In Progress", "Production", "Ready", "Completed", "Delivered"].map((s, i) => (
    ...
    content: (
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-6 bg-card rounded-xl shadow-sm space-y-3">
        ...
        <section>
          <div className="bg-emerald-50 p-6 rounded-xl">
            ...
            <ul className="space-y-3 text-sm text-emerald-800">
              ...
              <li className="flex gap-2">
                <CheckCircle2 size={16} className="mt-0.5 flex-shrink-0" />
                <span>Warn you if there is not enough stock</span>
              </li>
            </ul>
          </div>
        </section>

        <div className="bg-emerald-50/50 p-8 rounded-xl flex gap-4">
  ...
  },
  {
    ...
    content: (
      <div className="space-y-8">
        <p className="text-sm text-muted-foreground leading-relaxed">
          You do not need to be an accountant. The system does all the calculations to show you if you are making money or losing it.
        </p>
        ...
        <div className="bg-card rounded-xl overflow-hidden shadow-sm">
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex justify-between items-start pt-4">
              ...
              <span className="bg-primary text-primary-foreground font-bold px-4 py-1 rounded text-[10px] uppercase">= EQUALS</span>
            </div>
          </div>
        </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 bg-card rounded-xl shadow-sm space-y-2">
        ...
        <div className="flex gap-4 p-6 bg-card rounded-xl shadow-sm items-center">
    ...
    content: (
      <div className="space-y-8">
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-5 bg-card rounded-xl shadow-sm space-y-2">
        ...
        <div className="bg-cyan-50 p-6 rounded-xl flex gap-4">
    ...
    content: (
      <div className="space-y-6">
        <div className="space-y-4">
          <div className="p-5 bg-card rounded-xl shadow-sm">
            <p className="font-bold text-sm mb-1 text-primary">"Suggested price seems low?"</p>
            <p className="text-xs text-muted-foreground leading-relaxed">Increase profit margin or hourly rate in Settings.</p>
          </div>
          <div className="p-5 bg-card rounded-xl shadow-sm">
            <p className="font-bold text-sm mb-1 text-primary">"Mistake on an order?"</p>
            <p className="text-xs text-muted-foreground leading-relaxed">Click edit on the order to fix any detail.</p>
          </div>
          <div className="p-5 bg-card rounded-xl shadow-sm">
            <p className="font-bold text-sm mb-1 text-primary">"Can't find a material?"</p>
            <p className="text-xs text-muted-foreground leading-relaxed">Add it to Inventory first.</p>
          </div>
        </div>

        <div className="p-8 bg-primary rounded-xl text-primary-foreground text-center">
